  ...
  return (
    <div className="home-section">
      ...
      <div className="login-and-register">
        ...
        <button className="btn" id="loginBtn"onClick={(e)=> setLoginButtonLogic(e)}>Login</button>
        <button className="btn" id="registerBtn" onClick={(e)=> setLoginButtonLogic(e)}>Register</button>
      </div>
